...
class NewWorld {
private:
  std::unique_ptr<Textinput>
      textinput_name; // smart pointer textinput untuk mengelola instance text
  std::unique_ptr<Button>
      submit; // smart pointer button untuk membuat dunia baru
...
private:
  ...
  std::chrono::time_point<std::chrono::steady_clock>
      lastSave;   // waktu terakhir menyimpan
